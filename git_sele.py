...
def login_to_facebook(user, etsy):
    ua = UserAgent()
...
# Facebook login credentials for three accounts
credentials = [
    {"user": "one", "etsy": "one"}
...
if __name__ == "__main__":
    ...
    for cred in credentials:
        p = multiprocessing.Process(target=login_to_facebook, args=(cred["user"], cred["etsy"]))
        processes.append(p)
        p.start()
